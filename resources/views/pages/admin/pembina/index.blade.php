...
<div class="container-fluid">
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <a href="{{url('pembina')}}" style="text-decoration:none">Data Pembina </a>
    </div>
    ...
    <div class="card shadow mt-2">
        <div class="card-body">
            ...
            <ul class="nav">
                ...
                <li  class="scroll-to-section p-1"><a class="btn btn-primary btn-sm" href="/pembina/cetakall_pdf" target="_blank"><i class="fa fa-print"></i> Cetak</a> </li>
