...
<div class="container-fluid">
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <a href="{{url('user01')}}" style="text-decoration:none">Data Admin </a>
    </div>
    ...
    <div class="card shadow mt-2">
        <div class="card-body">
                ...
                <ul class="nav">
                               ...
                               <li  class="scroll-to-section p-1"><a class="btn btn-primary btn-sm" href="/user01/cetakall_pdf" target="_blank"><i class="fa fa-print"></i> Cetak</a> </li>
                    ...
                    <table class="table table-bordered table-hover text-center" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->roles }}</td>
                                <td>
                                    <a href="{{ asset('foto_admin/' .$item -> foto) }}" target="_blank">
                                        <img height="70px" width="50px" src="{{ asset('foto_admin/' .$item -> foto) }}" alt=""></a>
                                </td>
                                @if(Auth::user()->roles == 'ADMIN')
                                <td>
