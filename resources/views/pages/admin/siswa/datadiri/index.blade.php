...
<div class="container-fluid">
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <a href="{{url('siswa')}}" style="text-decoration:none">Data Siswa </a>
    </div>
    ...
    <div class="card shadow mt-2">
        <div class="card-body">
            ...
            <ul class="nav">
                ...
                <li  class="scroll-to-section p-1"><a class="btn btn-primary btn-sm" href="/siswa/cetakall_pdf" target="_blank"><i class="fa fa-print"></i> Cetak</a> </li>
