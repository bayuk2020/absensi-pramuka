    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @if(Auth::user()->roles == 'ADMIN')
                    <img class="img-profile rounded-circle" src="{{asset('foto_admin/'.Auth::user()->foto)}}" alt="">
                @elseif(Auth::user()->roles == 'PEMBINA')
                <img class="img-profile rounded-circle" src="{{asset('foto_pembina/'.Auth::user()->foto)}}" alt="">
                @else
                    <img class="img-profile rounded-circle" src="{{asset('foto_siswa/'.Auth::user()->foto)}}" alt="">
                @endif
        </a>
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
            aria-labelledby="userDropdown">
                ...
                @if(Auth::user()->roles == 'ADMIN')
                <a class="dropdown-item" href="{{ url('user01/'.Auth::user()->id.'/edit') }}">
